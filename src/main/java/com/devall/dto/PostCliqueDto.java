...
public class PostCliqueDto {
	...
	public PostCliqueDto() {
		super();
	}

	public PostCliqueDto(Long id, String titulo, String resumo, Integer cliques, Date dataInclusao, Date dataPublicacao,
